...
class ArtistAlbum extends StatelessWidget {
  ...
  ArtistAlbum({Key? key, required this.artist, required this.album})
      : super(key: key);
        ...
        child: Stack(
          ...
          children: [
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize:
                                        album.name!.length <= 9 ? 34.sp : 24.sp,
                                ...
                                return SingleChildScrollView(
                                  ...
                                  child: Row(
                                    children: List.generate(
                                      ...
                                      (index) {
                                        return state.albumEntity[index]
                                                    .albumId !=
                                                album.albumId
                                            ? AlbumTileWidget(
            ...
            GestureDetector(
              onTap: () {},
              child: Container(
                margin: EdgeInsets.only(top: 332.h, right: 7.w),
